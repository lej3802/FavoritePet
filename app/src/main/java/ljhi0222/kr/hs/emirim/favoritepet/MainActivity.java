package ljhi0222.kr.hs.emirim.favoritepet;
...
public class MainActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, View.OnClickListener{
    ...
    TextView textQuest;
    RadioGroup rg;
    RadioButton radioDog, radioCat, radioPig;
    Button butOk;
    ImageView imgvPet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioPig=(RadioButton) findViewById(R.id.radio_pig);
    ...
    public void onClick(View v) {
        switch (rg.getCheckedRadioButtonId()){
            ...
            case R.id.radio_cat :
                ...
                break;
            case R.id.radio_pig :
                imgvPet.setImageResource(R.drawable.guineapig);
                break;
            default :
